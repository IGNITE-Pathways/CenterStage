...
public class XBot {
    ...
    static final int ARM_POSITION_UP = 500;
    ...
    static final int EXPOSURE = 3; //Change this based on the amount of light in the room. Lower exposure if room is bright and vice-versa
}
