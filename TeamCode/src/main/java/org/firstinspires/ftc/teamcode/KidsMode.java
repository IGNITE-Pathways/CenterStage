...
public class KidsMode extends XBotOpMode {
    ...
    double KID_SAFE_SPEED_MULTIPLIER = 0.4; // 40% speed
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            while (opModeIsActive()) {
                ...
                double drive = -gamepad1.left_stick_y * KID_SAFE_SPEED_MULTIPLIER;  // Note: pushing stick forward gives negative value
                double strafe = -gamepad1.left_stick_x * KID_SAFE_SPEED_MULTIPLIER;
                double yawTurn = -gamepad1.right_stick_x * KID_SAFE_SPEED_MULTIPLIER;
